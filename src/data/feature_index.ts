...
import {featureFilter} from '@emuanalytics/maplibre-gl-style-spec';
...
import type {FeatureFilter, FeatureState, FilterSpecification, PromoteIdSpecification} from '@emuanalytics/maplibre-gl-style-spec';
