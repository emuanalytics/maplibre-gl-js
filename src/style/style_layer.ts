...
import {latest as styleSpec, supportsPropertyExpression} from '@emuanalytics/maplibre-gl-style-spec';
import {
    validateStyle,
...
import type {FeatureFilter, FeatureState,
    LayerSpecification,
    FilterSpecification} from '@emuanalytics/maplibre-gl-style-spec';
