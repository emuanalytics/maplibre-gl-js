import {interpolates, Color, latest as styleSpec} from '@emuanalytics/maplibre-gl-style-spec';
...
import type {StylePropertySpecification, LightSpecification} from '@emuanalytics/maplibre-gl-style-spec';
