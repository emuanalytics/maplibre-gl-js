import type {Expression, EvaluationContext, Type, ZoomConstantExpression} from '@emuanalytics/maplibre-gl-style-spec';
import {NullType} from '@emuanalytics/maplibre-gl-style-spec';
